...
```{r}
ggplot(data, aes(x=data$martial.status, y=data$Purchased.Bike))+
...
#Zmienna Region
```{r}
ggplot(data, aes(x=data$Region, y=data$Purchased.Bike))+
  geom_col(fill='red')+
  xlab('Region')+
...
#Zmienna Age
```{r}
ggplot(data, aes(x=data$Age, y=data$Purchased.Bike))+
  geom_col(fill='black')+
